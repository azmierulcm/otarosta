      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-4 text-left">
          ...
          <motion.div
            ...
            className="bg-bg w-full max-w-5xl md:rounded-[3rem] relative z-10 shadow-2xl overflow-hidden flex flex-col md:flex-row h-full md:h-[80vh]"
          >
            <button 
              onClick={onClose} 
            ...
            {/* Left: Image Carousel */}
            <div className="w-full md:w-3/5 bg-surface-2 relative group h-1/2 md:h-full">
              <img 
            ...
            <div className="w-full md:w-2/5 p-8 md:p-12 overflow-y-auto no-scrollbar flex flex-col">
              <div className="mb-8">
                 <div className="flex items-center gap-2 mb-4">
                    <span className="bg-accent/10 text-accent px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-accent/10">
                      {listing.category}
                    </span>
                    <span className="bg-surface-2 text-text-muted px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border border-border">
                      {listing.condition}
                    </span>
                 </div>
                 <h2 className="text-3xl font-black text-text leading-tight mb-2">{listing.title}</h2>
                 <p className="text-4xl font-black text-accent tracking-tighter">RM{listing.price}</p>
              </div>

              <div className="prose prose-sm text-text-muted font-medium leading-relaxed mb-10">
              ...
              <div className="space-y-6 mt-auto">
                 <div className="bg-surface p-6 rounded-3xl border border-border flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-black text-text-subtle uppercase tracking-widest mb-0.5">Verified Seller</p>
                      <p className="font-bold text-text">{listing.profiles?.full_name || "Crew Member"}</p>
                    </div>
                 ...
                 <p className="text-center text-[10px] text-text-subtle font-bold uppercase tracking-widest">
