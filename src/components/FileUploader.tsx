...
import { parseRoster } from '@/actions/parseRoster';

const FileUploader = () => {
  const { isLoading, setLoading, error, setError, setRoster } = useRosterStore();
      ...
      <div {...getRootProps()}>
        <motion.div
          ...
          className={`
            ...
            ${isDragActive ? 'border-rausch bg-rausch/5' : 'border-gray-200 hover:border-rausch/50 hover:bg-gray-50'}
        ...
        >
          ...
          <div className={`
            ...
            ${isDragActive ? 'bg-rausch text-white' : 'bg-gray-100 text-gray-400'}
          `}>
            {isLoading ? (
          ...
          <div className="mt-4 flex items-center gap-2 text-xs font-medium text-gray-400 bg-gray-50 px-4 py-2 rounded-full">
